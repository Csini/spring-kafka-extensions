...
/**
 * Represents an {@link Observer} and an {@link Observable} at the same time,
 * allowing KafkaObserver to multicast RecordMetaData as events from a single
 * source to multiple child {@code Observer}s.
 *
